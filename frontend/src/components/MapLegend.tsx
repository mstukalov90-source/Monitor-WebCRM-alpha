...
export function MapLegend({
  ...
  const items = useMemo(
    () => buildMapLegendItems(taskFeatures, layerConfigByKey, { showAreaOverlay, showDistrictBoundary }),
    [taskFeatures, layerConfigByKey, showAreaOverlay, showDistrictBoundary],
  )
